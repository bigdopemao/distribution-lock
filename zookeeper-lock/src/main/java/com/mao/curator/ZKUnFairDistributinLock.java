 ...
 * @create 2020-01-09
 **/
public class ZKUnFairDistributinLock implements Lock {
    ...
    public ZKUnFairDistributinLock(String lockPath) {
        this.lockPath = lockPath;
        RetryPolicy retryPolicy = new ExponentialBackoffRetry(1000, 3);
        CuratorFramework  client = CuratorFrameworkFactory.newClient("192.168.0.82:2181", retryPolicy);
        client.start();
        lock = new InterProcessMutex(client, lockPath, new UnFairLockInternalsDriver());
    }
